          ...
          <div class="col-auto">
            <div class="d-flex align-items-center justify-content-between">
              <div class="logos mr40">
                <a class="header-logo logo1" href="index"><img src="images/header-logo.svg" alt="Header Logo"></a>
                <a class="header-logo logo2" href="index"><img src="images/header-logo2.svg" alt="Header Logo"></a>
              </div>
