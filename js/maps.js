...
'<ul class="info d-block">'+
'<li><span class="flaticon-maps"></span>' +locationPhone+ '</li>'+
'<li><span class="flaticon-smartphone"></span>' +locationAddress+ '</li>'+
'</ul>'+
'</div>'+
'</div>'+
...
var locations=[
    [locationData('images/resource/listing/1-1.jpg', '5', '7', 'listing-single.html', "Equestrian Family Home",      '+61-8181-123 ', 'Nairobi City, CA, Kenya', 'sky', 'flaticon-tent', 'Hotel', 'Now Closed', ), 40.94401669296697, -74.16938781738281, 1, '<i class="icon flaticon-desk-bell"></i>'],
    [locationData('images/resource/listing/1-2.jpg', '5', '8', 'listing-single.html', "Luxury villa in Rego Park",  '+61-8236-920 ', 'Nairobi City, CA, Kenya', 'pink', 'flaticon-cutlery', 'Restaurant', 'Now Closed', ), 40.77055783505125, -74.26002502441406, 2, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/1-3.jpg', '5', '9', 'listing-single.html', "Villa on Hollywood Boulevard",'+61-8236-920 ', 'Nairobi City, CA, Kenya', 'purple', 'flaticon-tent', 'Art & History', 'Now Closed', ), 40.7427837, -73.11445617675781, 3, '<i class="icon flaticon-tent"></i>'], 
    [locationData('images/resource/listing/2-1.jpg', '5', '6', 'listing-single.html', "Triple Story House for Rent", '+61-8236-920 ', 'Nairobi City, CA, Kenya', 'green', 'flaticon-shopping-bag', 'Shopping', 'Now Closed', ), 40.70437865245596, -73.98674011230469, 4, '<i class="icon flaticon-shopping-bag"></i>'], 
    [locationData('images/resource/listing/2-2.jpg', '5', '5', 'listing-single.html', "Northwest Office Space",     '+61-8236-920 ', 'Nairobi City, CA, Kenya', 'pink', 'flaticon-cutlery', 'Restaurant', 'Now Closed', ), 40.641311, -73.778139, 5, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/2-3.jpg', '5', '4', 'listing-single.html', "House on the beverly hills", '+61-8236-920 ', 'Nairobi City, CA, Kenya', 'orange', 'flaticon-cutlery', 'Restaurant', 'Now Closed', ), 41.080938, -73.535957, 6, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/2-4.jpg', '5', '3', 'listing-single.html', "Luxury villa called Elvado ", '+61-8236-920 ', 'Nairobi City, CA, Kenya', 'dark-pink', 'flaticon-gym', ' Gym & Fitness ', 'Now Closed', ), 41.079386, -73.519478, 7, '<i class="icon flaticon-mirror"></i>'], 
];
