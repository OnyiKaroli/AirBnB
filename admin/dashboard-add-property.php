    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-md">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="dashboard-add-property.php" class="items-center -is-active"><i class="flaticon-new-tab mr15"></i>Add New Property</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="dashboard-properties.html" class="items-center"><i class="flaticon-home mr15"></i>My Properties</a>
          </div>
          <div class="sidebar_list_item ">
              ...
              <div class="dashboard_navigationbar">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="dashboard-add-property.php"><i class="flaticon-new-tab mr10"></i>Add New Property</a></li>
                    <li><a href="dashboard-properties.html"><i class="flaticon-home mr10"></i>My Properties</a></li>
                          ...
                          <div class="row">
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                ...
                                <input type="numeric" class="form-control" placeholder="Enter size">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Rooms</label>
                                <input type="numeric" class="form-control" placeholder="No of rooms">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Bedrooms</label>
                                <input type="numeric" class="form-control" placeholder="No of bedrooms">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Bathrooms</label>
                                <input type="numeric" class="form-control" placeholder="No of bathrooms">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
                                <label class="heading-color ff-heading fw600 mb10">Garage size</label>
                                <input type="numeric" class="form-control" placeholder="Garage size">
                              </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                              <div class="mb20">
