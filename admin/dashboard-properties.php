    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-md">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="dashboard-message.html" class="items-center"><i class="flaticon-chat-1 mr15"></i>Message</a>
          </div>
          <p class="fz15 fw400 ff-heading mt30">MANAGE LISTINGS</p>
          <div class="sidebar_list_item ">
            <a href="dashboard-add-property.php" class="items-center"><i class="flaticon-new-tab mr15"></i>Add New Property</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="dashboard-properties.html" class="items-center -is-active"><i class="flaticon-home mr15"></i>My Properties</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="dashboard-favorites.html" class="items-center"><i class="flaticon-like mr15"></i>My Favorites</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="dashboard-savesearch.html" class="items-center"><i class="flaticon-search-2 mr15"></i>Saved Search</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="dashboard-review.html" class="items-center"><i class="flaticon-review mr15"></i>Reviews</a>
          </div>
          <p class="fz15 fw400 ff-heading mt30">MANAGE ACCOUNT</p>
          <div class="sidebar_list_item ">
            <a href="dashboard-package.html" class="items-center"><i class="flaticon-protection mr15"></i>My Package</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="dashboard-profile.html" class="items-center"><i class="flaticon-user mr15"></i>My Profile</a>
          </div>
          <div class="sidebar_list_item ">
              ...
              <div class="dashboard_navigationbar">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="dashboard-properties.html"><i class="flaticon-home mr10"></i>My Properties</a></li>
                    <li><a href="dashboard-favorites.html"><i class="flaticon-like mr10"></i>My Favorites</a></li>
                    <li><a href="dashboard-savesearch.html"><i class="flaticon-search-2 mr10"></i>Saved Search</a></li>
                        ...
                        <th scope="row">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            ...
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                              <div class="h6 list-title"><a href="page-property-single-v1.html">Equestrian Family Home</a></div>
                              <p class="list-text mb-0">Nairobi City, CA, Kenya</p>
                      ...
                      <tr>
                        <th scope="row">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            ...
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                              <div class="h6 list-title"><a href="page-property-single-v1.html">Luxury villa in Rego Park</a></div>
                              <p class="list-text mb-0">Nairobi City, CA, Kenya</p>
                              <div class="list-price"><a href="">$14,000/<span>mo</span></a></div>
                            </div>
                          </div>
                      ...
                      <tr>
                        <th class="active">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            ...
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                              <div class="h6 list-title"><a href="page-property-single-v1.html">Villa on Hollywood Boulevard</a></div>
                              <p class="list-text mb-0">Nairobi City, CA, Kenya</p>
                              <div class="list-price"><a href="">$14,000/<span>mo</span></a></div>
                            </div>
                          </div>
                      ...
                      <tr>
                        <th scope="row">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            ...
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                              <div class="h6 list-title"><a href="page-property-single-v1.html">Triple Story House for Rent</a></div>
                              <p class="list-text mb-0">Nairobi City, CA, Kenya</p>
                              <div class="list-price"><a href="">$14,000/<span>mo</span></a></div>
                            </div>
                          </div>
                      ...
                      <tr>
                        <th scope="row">
                          <div class="listing-style1 dashboard-style d-xxl-flex align-items-center mb-0">
                            ...
                            <div class="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                              <div class="h6 list-title"><a href="page-property-single-v1.html">Northwest Office Space</a></div>
                              <p class="list-text mb-0">Nairobi City, CA, Kenya</p>
                              <div class="list-price"><a href="">$14,000/<span>mo</span></a></div>
                            </div>
                          </div>
