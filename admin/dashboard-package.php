    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-md">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="dashboard-save-search.html" class="items-center"><i class="flaticon-search-2 mr15"></i>Saved Search</a>
          </div>
          <div class="sidebar_list_item ">
          ...
          <div class="sidebar_list_item ">
            <a href="dashboard-package.html" class="items-center -is-active"><i class="flaticon-protection mr15"></i>My Package</a>
          </div>
          <div class="sidebar_list_item ">
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li><a href="dashboard-categories.html"><i class="flaticon-search-2 mr10"></i>Saved Search</a></li>
                    ...
                    <li class="active"><a href="dashboard-package.html"><i class="flaticon-protection mr10"></i>My Package</a></li>
