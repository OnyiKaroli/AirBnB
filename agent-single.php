        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center">
              ...
              <a class="ud-btn btn-transparent add-property bdrs60 mx-2 mx-xl-4" href="dashboard-add-property.php">Add Property<i class="fal fa-arrow-right-long"></i></a>
            ...
            <div class="col-xl-7">
              <div class="agent-single d-sm-flex align-items-center">
                ...
                <div class="single-contant ml30 ml0-xs">
                  <h2 class="title mb-0">Ali Tufan</h2>
                  <p class="fz15">Company Agent at <b>Modern House Real Estate</b></p>
                  <div class="agent-meta mb15 d-md-flex align-items-center">
                    ...
                    <a class="text fz15 pe-2 ps-2 bdrr1" href=""><i class="flaticon-call pe-1"></i>+848 032 03 01</a>
                    <a class="text fz15 ps-2" href=""><i class="flaticon-smartphone pe-1"></i>+848 032 03 01</a>
                  </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="agent-single-details mt30 pb30 bdrb1">
                  <h6 class="fz17 mb30">About Ali Tufan</h6>
