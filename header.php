          ...
          <div class="col-auto">
            <div class="d-flex align-items-center justify-content-between">
              <div class="logos mr35">
                <a class="header-logo logo1" href="index"><img src="images/header-logo.png" alt="Header Logo"></a>
                <a class="header-logo logo2" href="index"><img src="images/header-logo.png" alt="Header Logo"></a>
              </div>
